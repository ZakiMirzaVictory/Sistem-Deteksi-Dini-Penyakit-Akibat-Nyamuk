...
<title>Registrasi — Deteksi Dini Penyakit Akibat Nyamuk</title>
...
<div class="auth-shell">
  <div class="auth-card">
    ...
    <form>
      ...
      <button type="submit" class="btn btn-primary btn-block auth-submit">Daftar</button>
    </form>
 
    <p class="auth-footer">Sudah punya akun? <a href="login.html">Login</a></p>
  </div>
</div>
</body>
</html>
